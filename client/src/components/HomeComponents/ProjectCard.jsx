...
const ProjectCard = (props) => {
  ...
  const {projectTitle,projectCreator,isPrivate}=props
  return (
    <div className="card">
      <div className="img">
        <div className="save">
      ...
      <div className="text-card">
        <p className="project-card-title">{projectTitle}</p>
       {isPrivate ? (
        ...
        <p className="p">Creator: {projectCreator}</p>

        <div className="icon-box">
          <p className="span">Explore project</p>
        </div>
      </div>
    </div>
  );
